...
def principal() -> None:
    ...
    # Los índices auxiliares se reconstruyen automáticamente dentro de cada
    # método cargar_*_iniciales() del servicio Restaurante.
    ...
    print("  Índices auxiliares reconstruidos correctamente.")
